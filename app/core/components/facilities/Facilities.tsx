...
const Facilities: React.FC<FacilitiesProps> = ({ classNamePrincipal, classNameImg, isProductPage }) => {
    ...
    if (isProductPage) {
        return (
            <div className="w-full border-y border-secondary-blue bg-white">
                {/* Mobile: 3 columnas compactas */}
                <div className="
                    grid grid-cols-3
                    divide-x divide-secondary-blue
                    font-tertiary-font text-secondary-blue
                    py-[2.5vw] mobile:py-[1vw]
                ">
                    {/* Item 1: Referencias verificadas */}
                    <div className="flex flex-col items-center justify-center gap-[1vw] mobile:gap-[1.5vw] px-[1vw] mobile:px-[2vw] text-center">
                        <Image
                            src="/referencias.svg"
                            alt="referencias"
                            width={28}
                            height={28}
                            className="xl:w-[1.8vw] lg:w-[2.2vw] md:w-[2.8vw] sm:w-[3.5vw] mobile:w-[7vw]"
                        />
                    ...
                    <div className="flex flex-col items-center justify-center gap-[1vw] mobile:gap-[1.5vw] px-[1vw] mobile:px-[2vw] text-center">
                        ...
                        {/* <p className="xl:text-[0.7vw] lg:text-[0.85vw] md:text-[1vw] sm:text-[1.2vw] mobile:text-[2.1vw] text-dark-grey font-normal leading-tight">
                            (Consultar en Importación)
                        </p> */}
                    </div>
