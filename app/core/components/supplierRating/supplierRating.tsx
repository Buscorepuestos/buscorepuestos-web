...
const SupplierRating: React.FC<SupplierRatingProps> = ({ valoration, location, title }) => {
    return (
        <div>
            <div className='xl:w-[17vw] lg:w-[21vw] md:w-[24vw] sm:w-[26vw] mobile:w-[49vw] pl-[1.2vw] mobile:pl-[2vw] pr-[1vw] flex flex-col bg-custom-white border-secondary-blue border-[2px] rounded-3xl shadow-lg shadow-zinc-400'>
                ...
                <div className="w-full flex gap-4 mobile:gap-3 items-center mb-3 mobile:mt-0">
                    ...
                    <div className="flex flex-shrink-0 flex-row gap-4 mobile:gap-2">
