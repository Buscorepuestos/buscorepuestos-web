...
const PaymentSuccess = () => {
			...
			if (paymentIntent) {
				if (paymentIntent?.status === 'succeeded') {
					...
					if (storedBillingData) {
						try {
							const parsedBillingData =
								JSON.parse(storedBillingData)
							setBillingData(parsedBillingData)

                            const storedExtraData =
                                localStorage.getItem('extraData')
                            ...
                            //     id: parsedBillingData.id,
                            //     ["correo electronico"]: emailData.email,
                            // })
	...
	return (
		<div className="flex items-center justify-center min-h-screen font-tertiary-font mt-[8vw]">
			<div className="w-full max-w-[60vw] border-[4px] border-secondary-blue p-12 rounded-xl shadow-xl bg-white">
				<p className="font-bold text-primary-blue text-[2.8rem] text-center mb-6">Pago exitoso</p>
                    ...
                    <div>
                        <div className='grid grid-cols-2 justify-center justify-items-center'>
                            <div className="space-y-4 text-[2.3rem] text-dark-grey">
                                ...
                                <p>
                                    <strong>Nombre y apellidos:</strong> {billingData.name}
                                </p>
                                <p>
                                ...
                                <p>
                                    <strong>Provincia:</strong> {billingData.province}
                                </p>
                                <p>
                                    <strong>Ciudad:</strong> {billingData.location}
                                </p>
                                <p>
                                    <strong>País:</strong> {billingData.country}
                                </p>
                                <p>
                                    <strong>Código Postal:</strong> {billingData.cp}
                                </p>
                                <p>
                            ...
                            <div className="space-y-4 text-[2.3rem] text-dark-grey">
                                ...
                                <p>
                                    <strong>Dirección:</strong> {extraData.billingAddress}
                                </p>
                                <p>
                                    <strong>Número de Dirección:</strong>{' '}
