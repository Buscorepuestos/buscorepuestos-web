			...
			<section className="pt-[72px]">
				...
				<section className="flex flex-col items-end relative bottom-12 mobile:hidden">
					...
					<TagBanner title={'Eficacia'} fontColor={'white'} color={'#12B1BB'} width={'870px'}
							   height={'130px'} align={'center'} alignItems={'center'} position={'relative'} zIndex={'2'} axis={'bottom-5'}
							   radius={'rounded-tl-3xl rounded-bl-3xl'}>
					...
					<TagBanner title={'100% Fiabilidad'} fontColor={'white'} color={'#1A61F1'} width={'650px'}
							   height={'130px'} align={'center'} alignItems={'center'} position={'relative'} zIndex={'2'} axis={'bottom-9'}
							   radius={'rounded-tl-3xl rounded-bl-3xl'}>
				...
				<section className="desktop:hidden flex justify-center relative z-10" style={{ bottom: '700px' }}>
					<div className="flex flex-col align-end w-[100vw]">
						<TagBanner title={'Rapidez'} flexDir={'flex-col'} fontColor={'white'} color={'#3A27B0'}
								   ...
								   radius={'rounded-tl-3xl rounded-bl-3xl'} padding={'p-6 pl-12'}>
						...
						<TagBanner title={'100% Fiabilidad'} flexDir={'flex-col'} fontColor={'white'} color={'#1A61F1'}
								   ...
								   align={'left'} alignItems={'left'} alignSelf={'self-end'}
								   radius={'rounded-tl-3xl rounded-bl-3xl'} padding={'p-6 pl-12'}>
							<p className="text-title-4 font-light">Devoluciones sin coste en el plazo de <span className={'font-semibold'}>14 días.
